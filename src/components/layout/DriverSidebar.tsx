...
import { LayoutDashboard, LogOut, X, Car, Briefcase, FileText, User, PoundSterling, MessageSquare, Wallet, History, PlusCircle, Map } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { href: '/dashboard/driver/map',            label: 'Live Tracking',  icon: Map },
